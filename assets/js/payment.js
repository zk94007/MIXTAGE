if (typeof(PAYMENT_JS) === 'undefined') {
    ...
    function pay_approval() {
        ...
        if (pg_type === 'kcp') {
            ...
            f.buyr_name.value = pf.user_realname.value;
            f.buyr_mail.value = pf.user_email.value;
            f.buyr_tel1.value = pf.user_phone.value;
            f.buyr_tel2.value = pf.user_phone.value;
            f.rcvr_name.value = pf.user_realname.value;
            f.rcvr_tel1.value = pf.user_phone.value;
            f.rcvr_tel2.value = pf.user_phone.value;
            f.rcvr_mail.value = pf.user_email.value;
            ...
            f.LGD_BUYER.value = pf.user_realname.value;
            f.LGD_BUYEREMAIL.value = pf.user_email.value;
            f.LGD_BUYERPHONE.value = pf.user_phone.value;
            f.LGD_AMOUNT.value = pf.good_mny.value;
            f.LGD_PRODUCTINFO.value = good_name;
            f.LGD_RECEIVER.value = pf.user_realname.value;
            f.LGD_RECEIVERPHONE.value = pf.user_phone.value;
            ...
            f.P_UNAME.value = pf.user_realname.value;
            f.P_MOBILE.value = pf.user_phone.value;
            f.P_EMAIL.value = pf.user_email.value;
            f.P_RETURN_URL.value = ci_url + '/payment/inicis_pay_return/' + ptype + '/' + payment_unique_id;
        ...
        $.ajax({
            type: 'post',
            data: order_data,
            url: ci_url + '/payment/orderdatasave',
            cache: false,
            async: false,
        ...
        if (ci_device_type !== 'mobile') {
            ...
            if (use_pg === '1') {
                ...
                if (pg_type === 'kcp') {
                    ...
                    f.good_name.value = good_name;
                    f.buyr_name.value = f.user_realname.value;
                    f.buyr_mail.value = f.user_email.value;
                    f.buyr_tel1.value = f.user_phone.value;
                    f.buyr_tel2.value = f.user_phone.value;
                    f.rcvr_name.value = f.user_realname.value;
                    f.rcvr_tel1.value = f.user_phone.value;
                    f.rcvr_tel2.value = f.user_phone.value;
                    f.rcvr_mail.value = f.user_email.value;
                    ...
                    f.LGD_PRODUCTINFO.value = good_name;
                    f.LGD_BUYER.value = f.user_realname.value;
                    f.LGD_BUYEREMAIL.value = f.user_email.value;
                    f.LGD_BUYERPHONE.value = f.user_phone.value;
                    f.LGD_AMOUNT.value = f.good_mny.value;
                    f.LGD_RECEIVER.value = f.user_realname.value;
                    f.LGD_RECEIVERPHONE.value = f.user_phone.value;
                    ...
                    f.buyername.value = f.user_realname.value;
                    f.buyeremail.value = f.user_email.value;
                    f.buyertel.value = f.user_phone.value;
                    f.recvname.value = f.user_realname.value;
                    f.recvtel.value = f.user_phone.value;
