...
V.Link = {
    ...
    matchFrameHeight: function () {
        ...
        this.intervalNum = window.setInterval(jQuery.proxy(this.setFrameHeight, this), 200)
    },
    setFrameHeight: function () {
        var a = this.getDocumentHeight();
        if (a != this.contentHeight) {
            this.contentHeight = a;
            jQuery("#contentFrame").height(a)
        }
        else {
