$.validator.addMethod('is_userid_available', function (value, element) {
    ...
    $.ajax({
        type: 'post',
        url: ci_url + '/register/ajax_userid_check',
        data: {
...
$.validator.addMethod('is_email_available', function (value, element) {
    ...
    $.ajax({
        type: 'post',
        url: ci_url + '/register/ajax_email_check',
        data: {
            csrf_test_name: ci_csrf_hash,
            email: value
        },
...
$.validator.addMethod('is_password_available', function (value, element) {
    ...
    $.ajax({
        type: 'post',
        url: ci_url + '/register/ajax_password_check',
        data: {
            csrf_test_name: ci_csrf_hash,
            password: value
        },
...
$.validator.addMethod('is_nickname_available', function (value, element) {
    ...
    $.ajax({
        type: 'post',
        url: ci_url + '/register/ajax_nickname_check',
        data: {
            csrf_test_name: ci_csrf_hash,
            nickname: value
        },
