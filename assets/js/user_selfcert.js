...
// 아이핀인증
$(document).on('click', '#btn_user_selfcert_ipin', function () {
    if (!selfcert_confirm())
        return false;

    var openurl = ci_url + '/selfcert/ipin';
...
// 휴대폰인증
$(document).on('click', '#btn_user_selfcert_phone', function () {
    if (!selfcert_confirm())
        return false;

    var openurl = ci_url + '/selfcert/phone';
