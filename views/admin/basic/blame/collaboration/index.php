                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    ?>
                        <tr>
							...
							<td><a href="?sfield=collaboration_blame.user_id&amp;skeyword=<?php echo element('user_id', $result); ?>"><?php echo html_escape(element('user_userid', $result)); ?></a></td>
                            <td><?php echo display_datetime(element('cbl_datetime', $result), 'full'); ?></td>
