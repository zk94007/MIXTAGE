        ...
        ?>
            <div class="box-table-header">
                <ul class="nav nav-pills">
                    <li role="presentation" class="active"><a href="<?php echo admin_url($this->pagedir); ?>">Blame</a></li>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-striped table-bordered">
                    <thead>
                        <tr>
                            <th><a href="<?php echo element('bla_id', element('sort', $view)); ?>">No</a></th>
                            <th colspan="2">User who is blamed</th>
                            <th colspan="2">User who blames</th>
                            <th>Blame date</th>
                    ...
                    ?>
                        <tr>
							...
							<td><a href="?sfield=user_blame.user_id&amp;skeyword=<?php echo element('user_id', $result); ?>"><?php echo html_escape(element('user_userid', $result)); ?></a></td>
                            <td><?php echo display_datetime(element('ubl_datetime', $result), 'full'); ?></td>
