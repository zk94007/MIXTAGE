                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="?sfield=user_login_log.user_id&amp;skeyword=<?php echo element('user_id', $result); ?>"><?php echo html_escape(element('user_userid', $result)); ?></a></td>
                            <td><?php echo element('display_name', $result); ?></td>
                            <td><a href="?sfield=ull_userid&amp;skeyword=<?php echo html_escape(element('ull_userid', $result)); ?>"><?php echo html_escape(element('ull_userid', $result)); ?></a></td>
                            <td><?php echo element('ull_success', $result) === '1' ? "<span class=\"label label-success\">Success</span>":"<span class=\"label label-danger\">Fail</span>"; ?></td>
                            <td><?php echo element('ull_reason', $result); ?></td>
                            <td><a href="?sfield=ull_ip&amp;skeyword=<?php echo display_admin_ip(element('ull_ip', $result)); ?>"><?php echo display_admin_ip(element('ull_ip', $result)); ?></a></td>
                            ...
                            <td><?php echo display_datetime(element('ull_datetime', $result), 'full'); ?></td>
