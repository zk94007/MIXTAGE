<div class="box">
    <div class="box-header">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation"><a href="<?php echo admin_url($this->pagedir . '/usermodify'); ?>" onclick="return check_form_changed();">정보수정시</a></li>
        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label for="use_user_photo" class="checkbox-inline">
                            <input type="checkbox" name="use_user_photo" id="use_user_photo" value="1" <?php echo set_checkbox('use_user_photo', '1', (element('use_user_photo', element('data', $view)) ? true : false)); ?> /> 사용합니다,
                        </label>
                        가로길이 <input type="number" class="form-control" name="user_photo_width" id="user_photo_width" value="<?php echo set_value('user_photo_width', element('user_photo_width', element('data', $view)) + 0); ?>" />px,
                        세로길이 <input type="number" class="form-control" name="user_photo_height" id="user_photo_height" value="<?php echo set_value('user_photo_height', element('user_photo_height', element('data', $view)) + 0); ?>" />px
                        (jpg, gif, png 만 가능)
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label for="use_user_icon" class="checkbox-inline">
                            <input type="checkbox" name="use_user_icon" id="use_user_icon" value="1" <?php echo set_checkbox('use_user_icon', '1', (element('use_user_icon', element('data', $view)) ? true : false)); ?> /> 사용합니다,
                        </label>
                        가로길이 <input type="number" class="form-control" name="user_icon_width" id="user_icon_width" value="<?php echo set_value('user_icon_width', element('user_icon_width', element('data', $view)) + 0); ?>" />px,
                        세로길이 <input type="number" class="form-control" name="user_icon_height" id="user_icon_height" value="<?php echo set_value('user_icon_height', element('user_icon_height', element('data', $view)) + 0); ?>" />px
                        (jpg, gif, png 만 가능)
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="5" name="user_register_policy1"><?php echo set_value('user_register_policy1', element('user_register_policy1', element('data', $view))); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">개인정보취급방침</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="5" name="user_register_policy2"><?php echo set_value('user_register_policy2', element('user_register_policy2', element('data', $view))); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
