<div class="box">
    <div class="box-header">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="<?php echo admin_url($this->pagedir . '/usermodify'); ?>" onclick="return check_form_changed();">정보수정시</a></li>
        ...
        ?>
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="change_nickname_date" id="change_nickname_date" value="<?php echo set_value('change_nickname_date', element('change_nickname_date', element('data', $view)) + 0); ?>" />일,
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="change_open_profile_date" id="change_open_profile_date" value="<?php echo set_value('change_open_profile_date', element('change_open_profile_date', element('data', $view)) + 0); ?>" />일,
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="change_use_note_date" id="change_use_note_date" value="<?php echo set_value('change_use_note_date', element('change_use_note_date', element('data', $view)) + 0); ?>" />일,
