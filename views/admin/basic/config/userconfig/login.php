        ...
        ?>
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="change_password_date" id="change_password_date" value="<?php echo set_value('change_password_date', element('change_password_date', element('data', $view)) + 0); ?>" /> 일,
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="max_login_try_count" id="max_login_try_count" value="<?php echo set_value('max_login_try_count', element('max_login_try_count', element('data', $view)) + 0); ?>" /> 회,
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="max_login_try_limit_second" id="max_login_try_limit_second" value="<?php echo set_value('max_login_try_limit_second', element('max_login_try_limit_second', element('data', $view)) + 0); ?>" />초, <span class="help-inline"> 위에서 설정한 횟수 이상 로그인실실패하였을 경우, 해당 초 동안 로그인 시도를 할 수 없습니다</span>
                    </div>
                </div>
                <div class="form-group">
