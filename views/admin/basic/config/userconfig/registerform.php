            ...
            <div class="form-horizontal">
                <div class="list-group">
                    <div class="form-group list-group-item">
                        ...
                        <div class="col-sm-1"><button type="button" class="btn btn-primary btn-xs btn-add-rows">추가</button></div>
                    </div>
                    <div id="sortable">
                    <?php
                    ...
                    ?>
                        <div class="form-group list-group-item">
                            ...
                            <div class="col-sm-1"><button type="button" class="btn btn-default btn-xs btn-delete-row" >삭제</button></div>
                        </div>
                    <?php
                            }
                        }
