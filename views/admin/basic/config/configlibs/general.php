        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        PC - <input type="number" class="form-control" name="document_thumb_width" id="document_thumb_width" value="<?php echo set_value('document_thumb_width', element('document_thumb_width', element('data', $view)) + 0); ?>" />px,
                        모바일 - <input type="number" class="form-control" name="document_mobile_thumb_width" id="document_mobile_thumb_width" value="<?php echo set_value('document_mobile_thumb_width', element('document_mobile_thumb_width', element('data', $view)) + 0); ?>" />px
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        PC - <input type="number" class="form-control" name="faq_thumb_width" id="faq_thumb_width" value="<?php echo set_value('faq_thumb_width', element('faq_thumb_width', element('data', $view)) + 0); ?>" />px,
                        모바일 - <input type="number" class="form-control" name="faq_mobile_thumb_width" id="faq_mobile_thumb_width" value="<?php echo set_value('faq_mobile_thumb_width', element('faq_mobile_thumb_width', element('data', $view)) + 0); ?>" />px
