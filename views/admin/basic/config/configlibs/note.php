        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        PC <input type="number" class="form-control" name="note_list_page" id="note_list_page" value="<?php echo set_value('note_list_page', element('note_list_page', element('data', $view)) + 0); ?>" />,
                        모바일 <input type="number" class="form-control" name="note_mobile_list_page" id="note_mobile_list_page" value="<?php echo set_value('note_mobile_list_page', element('note_mobile_list_page', element('data', $view)) + 0); ?>" />
