        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="point_register" id="point_register" value="<?php echo set_value('point_register', element('point_register', element('data', $view)) + 0); ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">로그인시 포인트</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="point_login" id="point_login" value="<?php echo set_value('point_login', element('point_login', element('data', $view)) + 0); ?>" /> 하루에 한번 적용
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">회원가입시 추천인에게 포인트</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="point_recommended" id="point_recommended" value="<?php echo set_value('point_recommended', element('point_recommended', element('data', $view)) + 0); ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">추천인 존재시 가입자에게 포인트</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="point_recommender" id="point_recommender" value="<?php echo set_value('point_recommender', element('point_recommender', element('data', $view)) + 0); ?>" /> 회원가입 포인트와 별도로 적용됩니다
                    </div>
                </div>
                <div class="form-group">
