                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th colspan="2">Comment content</th>
                            <th>comment date</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><img src="<?php echo portfolio_image_url(element('por_cover_image_name', $result)); ?>" class="thumbnail mg0" style="width:80px;" /></td>
							...
							<td><a href="?sfield=portfolio.user_id&amp;skeyword=<?php echo element('por_user_id', $result); ?>"><?php echo html_escape(element('user_userid', element('target_user', $result))); ?></a></td>
                            <td><?php echo html_escape(element('pco_content', $result)); ?></td>
                            <td><?php echo element('display_name', $result); ?></td>
							<td><a href="?sfield=portfolio_comment.pco_user_id&amp;skeyword=<?php echo element('pco_user_id', $result); ?>"><?php echo html_escape(element('user_userid', $result)); ?></a></td>
                            <td><?php echo display_datetime(element('pco_datetime', $result), 'full'); ?></td>
