                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    ?>
                        <tr>
							...
							<td><a href="?sfield=portfolio_like.user_id&amp;skeyword=<?php echo element('user_id', $result); ?>"><?php echo html_escape(element('user_userid', $result)); ?></a></td>
