        ...
        ?>
            ...
            ?>
                <div class="btn-group pull-right" role="group" aria-label="...">
                    ...
                    <a href="<?php echo element('write_url', $view); ?>" class="btn btn-danger btn-sm">페이지추가</a>
                </div>
            <?php
                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo element('display_name', $result); ?> <?php if (element('user_userid', $result)) { ?> ( <a href="?sfield=document.user_id&amp;skeyword=<?php echo element('user_id', $result); ?>"><?php echo html_escape(element('user_userid', $result)); ?></a> ) <?php } ?></td>
