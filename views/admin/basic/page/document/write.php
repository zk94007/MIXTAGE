        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo display_dhtml_editor('doc_content', set_value('doc_content', element('doc_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = $this->configlib->item('use_document_dhtml'), $editor_type = $this->configlib->item('document_editor_type')); ?>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">모바일내용</label>
                    <div class="col-sm-10">
                        <?php echo display_dhtml_editor('doc_mobile_content', set_value('doc_mobile_content', element('doc_mobile_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = $this->configlib->item('use_document_dhtml'), $editor_type = $this->configlib->item('document_editor_type')); ?>
