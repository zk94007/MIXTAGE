...
<div class="wrapper">
        ...
        <div class="container">
            <ul class="header-top-menu">
                ...
                if ($this->userlib->is_user()) {
                    if ($this->configlib->item('use_notification')) {
                ?>
    ...
    <nav class="navbar">
        <div class="container">
            <div class="logo pull-left">
                <a href="<?php echo site_url(); ?>" title="<?php echo html_escape($this->configlib->item('site_title'));?>"><?php echo $this->configlib->item('site_logo'); ?></a>
            </div>
    ...
    <footer>
        <div class="container">
            ...
            <div class="copyright">
                <?php if ($this->configlib->item('company_address')) { ?>
                    <span><?php echo $this->configlib->item('company_address'); ?>
                        <?php if ($this->configlib->item('company_zipcode')) { ?>(우편 <?php echo $this->configlib->item('company_zipcode'); ?>)<?php } ?>
                    </span>
                <?php } ?>
                <?php if ($this->configlib->item('company_owner')) { ?><span><b>대표</b> <?php echo $this->configlib->item('company_owner'); ?></span><?php } ?>
                <?php if ($this->configlib->item('company_phone')) { ?><span><b>전화</b> <?php echo $this->configlib->item('company_phone'); ?></span><?php } ?>
                <?php if ($this->configlib->item('company_fax')) { ?><span><b>팩스</b> <?php echo $this->configlib->item('company_fax'); ?></span><?php } ?>
            </div>
            <div class="copyright">
                <?php if ($this->configlib->item('company_reg_no')) { ?><span><b>사업자</b> <?php echo $this->configlib->item('company_reg_no'); ?></span><?php } ?>
                <?php if ($this->configlib->item('company_retail_sale_no')) { ?><span><b>통신판매</b> <?php echo $this->configlib->item('company_retail_sale_no'); ?></span><?php } ?>
                <?php if ($this->configlib->item('company_added_sale_no')) { ?><span><b>부가통신</b> <?php echo $this->configlib->item('company_added_sale_no'); ?></span><?php } ?>
                <?php if ($this->configlib->item('company_admin_name')) { ?><span><b>정보관리책임자명</b> <?php echo $this->configlib->item('company_admin_name'); ?></span><?php } ?>
                <span>Copyright&copy; <?php echo $this->configlib->item('site_title'); ?>. All Rights Reserved.</span>
            </div>
            <?php
            if ($this->configlib->get_device_view_type() === 'mobile') {
            ?>
                <div class="see_mobile"><a href="<?php echo current_full_url(); ?>" class="btn btn-primary btn-xs viewpcversion">PC 버전으로 보기</a></div>
            <?php
            } else {
                if ($this->configlib->get_device_type() === 'mobile') {
            ?>
