        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-lg-12">
                    <textarea class="form-control" rows="3" readonly="readonly"><?php echo html_escape(element('user_register_policy1', $view)); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-12">
                ...
                <div class="form-group">
                    <div class="col-lg-12">
                        <textarea class="form-control" rows="3" readonly="readonly"><?php echo html_escape(element('user_register_policy2', $view)); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-12">
