            ...
            <div class="table-body">
                <ol class="registeragree">
                    <li>
                        ...
                        <textarea class="input" rows="3" readonly="readonly"><?php echo html_escape(element('user_register_policy1', $view)); ?></textarea>
                        <div class="checkbox">
                            <label for="agree">
                    ...
                    <li class="mt20">
                        ...
                        <textarea class="input" rows="3" readonly="readonly"><?php echo html_escape(element('user_register_policy2', $view)); ?></textarea>
                        <div class="checkbox">
                            <label for="agree2">
