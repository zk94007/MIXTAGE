...
class Tag_search extends CI_Controller
{
	...
	function main()
	{
		...
		$this->CI->load->model(array('Portfolio_model', 'Collaboration_model', 'Collaboration_user_model', 'Portfolio_blame_model', 'Portfolio_clip_model', 'Portfolio_like_model', 'Portfolio_tag_model'));

		$q = $this->CI->input->get('q');

		$result = $this->CI->Portfolio_model->get_tag_list_data($q);
