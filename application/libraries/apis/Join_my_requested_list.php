...
/**
 * Join_my_requested_list
 */


class Join_my_requested_list extends CI_Controller
{
	...
	function main()
	{
		...
		$list = $this->CI->Collaboration_request_model->get_requested_list(element('user_id', $sessionuser), $type);
