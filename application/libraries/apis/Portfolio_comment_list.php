...
class Portfolio_comment_list extends CI_Controller
{
	...
	function main()
	{
		...
		$category_id = (int) trim($this->CI->input->get('category_id'));
		...
		$this->CI->load->model(array('Portfolio_model', 'Collaboration_model', 'Collaboration_user_model', 'Portfolio_blame_model', 'Portfolio_comment_model', 'Portfolio_clip_model', 'Portfolio_like_model'));

		$result = $this->CI->Portfolio_model->get_personal_comment_list_data($user_id, $category_id, $is_collaboration);
