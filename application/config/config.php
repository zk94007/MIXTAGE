...
/**
 * URL 주소에 쓰이는 URI 부분의 첫번째 요소를 정의합니다.
...
$config['base_url'] = (is_https() ? 'https' : 'http').'://'.$server_addr
...
/**
 * 기본적으로 후크 기능을 사용하므로, 아래의 값을 변경하시면 안됩니다.
 */
...
/**
 * 기본적으로 MY_ prefix 로 클래스를 생성하여 배포합니다..
 */
...
/**
 * 로그 경로는 기본적으로 application/logs 로 설정되어있습니다.
...
/**
 * 로그파일명 포맷입니다. 원하시는 경우 필요한 포맷으로 변경하셔도 좋습니다
 */
...
/**
 * 캐시 경로는 기본적으로 application/cache 로 설정되어있습니다.
...
$config['cookie_domain'] = ''; // .domain.com 와 같이 맨 앞에 . 을 찍고 도메인 명을 적습니다
$config['cookie_path'] = '/';
...
/**
 * csrf protection 을 사용하지 않고 싶은 경우 FALSE 로 변경하시면 됩니다.
