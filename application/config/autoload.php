 ...
 */
$autoload['libraries'] = array('session', 'layoutlib', 'userlib', 'configlib', 'user_agent', 'mixtage');
 ...
 */
$autoload['helper'] = array('url', 'basic', 'thumbnail', 'cookie', 'basic_mixtage');
 ...
 */
$autoload['config'] = array('ci_config', 'ci_mixtage_config');
