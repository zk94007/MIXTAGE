...
class Document extends MY_Controller
{
    ...
    public function index()
    {
         ...
         */
        $this->{$this->modelname}->allow_search_field = array('doc_id', 'doc_key', 'doc_title', 'doc_layout', 'doc_mobile_layout', 'doc_skin', 'doc_mobile_skin', 'doc_datetime', 'doc_updated_datetime', 'document.user_id', 'doc_content', 'doc_mobile_content'); // 검색이 가능한 필드
        $this->{$this->modelname}->search_field_equal = array('doc_id', 'document.user_id'); // 검색중 like 가 아닌 = 검색을 하는 필드
    ...
    public function write($pid = 0)
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $content_type = $this->configlib->item('use_document_dhtml') ? 1 : 0;
            ...
            $updatedata = array(
                ...
                'doc_updated_user_id' => $this->userlib->item('user_id'),
