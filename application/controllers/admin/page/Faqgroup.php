 ...
 */
class Faqgroup extends MY_Controller
{
    ...
    public function index()
    {
         ...
         */
        $this->{$this->modelname}->allow_search_field = array('fgr_id', 'sfield', 'faq_group.user_id', 'fgr_title'); // 검색이 가능한 필드
        $this->{$this->modelname}->search_field_equal = array('fgr_id', 'faq_group.user_id'); // 검색중 like 가 아닌 = 검색을 하는 필드
        $this->{$this->modelname}->allow_order_field = array('fgr_id', 'fgr_datetime'); // 정렬이 가능한 필드
         ...
         */
        $search_option = array('fgr_title' => 'Title', 'fgr_datetime' => 'Date');
